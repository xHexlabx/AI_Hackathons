"""HexTex Kaggriculture agent v13 - correct strawberry production timing (EOD of ages 9/11/13/15), bigger opening herd.
...
def agent(obs, config=None):
    ...
    try:
        ...
        print(f"[hextex_v13] step {obs.get('step')} error: {exc!r}")
