"""HexTex Kaggriculture agent v4 - goose economy with strict cash & labour discipline.
...
class Brain:
    ...
    def market_orders(self, obs, me, private, day, hour, carried, stats, dropping):
        ...
        if (day == 0 and self.p["open_land"] and n_quads < 2) or (
            ...
            and len(empties) < self.p["land_min_free"]
        ):
...
def agent(obs, config=None):
    ...
    try:
        ...
        print(f"[hextex_v4] step {obs.get('step')} error: {exc!r}")
