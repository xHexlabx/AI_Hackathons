"""HexTex Kaggriculture agent v18 - v15 + melons are carried to the shed and sold immediately (beat the opponent's day-10 dump).
...
def agent(obs, config=None):
    ...
    try:
        ...
        print(f"[hextex_v18] step {obs.get('step')} error: {exc!r}")
