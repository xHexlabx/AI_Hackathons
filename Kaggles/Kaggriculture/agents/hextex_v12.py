"""HexTex Kaggriculture agent v12 - herds sized by town demand minus the opponent's visible supply; full crew early.
            ...
            if is_free(t):
                ...
                if cd["ongoing"]:
                    ...
                    if not t["watered_today"]:
                        base_w = 80 if age >= 8 else 60  # unwatered production day halves the bonus
                        add(
                            pos,
                            ["WATER"],
                            (90 + hour // 2)
...
def agent(obs, config=None):
    ...
    try:
        ...
        print(f"[hextex_v12] step {obs.get('step')} error: {exc!r}")
